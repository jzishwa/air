                    ...
                    <div class="card-body">
                        <form action="<?= BASEURL; ?>/pembayaran/add" method="POST">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_tagihan" id="id_tagihan" class="form-control" value="<?= $data['id_tagihan'] ?>">
                                <input type="text" name="pelanggan" id="pelanggan" class="form-control" value="<?= $data['pelanggan']; ?>" readonly>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="pakai">Jumlah Pemakaian</label>
                                    <input type="number" min="0" class="form-control" id="pakai" name="pakai" value="<?= $data['akhir'] - $data['awal']; ?>" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="total">Biaya Tambahan</label>
                                    <input type="number" min="0" class="form-control" id="tambahan" name="tambahan" value="<?= $data['tarif_ht']; ?>" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="total">Total Biaya</label>
                                    <input type="number" min="0" class="form-control" id="total" name="total" value="<?= ($data['akhir'] - $data['awal']) * $data['tarif'] + $data['tarif_ht']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
