...
<!-- Mirrored from spark.bootlab.io/pages-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 16:55:27 GMT -->
<!-- Added by HTTrack -->
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        <img src="<?= BASEURL; ?>/public/img/avatars/avatar.jpg" alt="Linda Miller" class="img-fluid rounded-circle" width="132" height="132" />
                                    </div>
                                    <div class="my-2">
                                        <?php Flash::info(); ?>
                                    </div>
                                    <form method="POST" action="<?= BASEURL; ?>/login/verif">
