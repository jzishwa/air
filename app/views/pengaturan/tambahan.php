    ...
    <div class="container-fluid">
        ...
        <div class="header">
            <h1 class="header-title">
                Daftar Harga Tambahan
            </h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Pengaturan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Daftar Harga Tambahan</li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <?= Flash::info(); ?>
                        <h5 class="card-title float-left d-block">Daftar Tarif Harga Tambahan</h5>
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatables-basic" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($data['harga'] as $harga) : $harga['tarif_ht'] = 'Rp. ' . number_format($harga['tarif_ht'], 2, ',', '.'); ?>
                                    <tr>
                                        <td><?= $i; ?></td>
                                        <td><?= $harga['tarif_ht']; ?></td>
                                        <td><?= $harga['ket_ht']; ?></td>
                                        <?php if ($_SESSION['level'] == 'Administrator') { ?>
                                            <td><a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusModal<?= $i; ?>">Hapus</a>
                                                <button class=" tombolEdit btn btn-primary btn-sm" data-target="#modal" data-toggle="modal" data-id="<?= $harga['id_ht']; ?>">edit</button>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Apakah Anda yakin akan menghapus <b><?= $harga['ket_ht']; ?></b></p>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="<?= BASEURL; ?>/harga/hapusht/<?= $harga['id_ht'] ?>" class="btn btn-success">Iya</a>
            ...
            <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalLabel">Tambah Harga Tambahan</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
